...
def DisplayNodeContent(pNode,lSdkManager, lScene):
    ...
    if pNode.GetNodeAttribute() == None:
        ...
        DisplayBoneAndMesh(pNode.GetName(), lMesh, lSdkManager, lScene)
...
def DisplayBoneAndMesh(nodeName, lMesh, lSdkManager, pScene):
    ...
    pY3dUncompressedFile, y3dUncompressedFileName , y3dFileName = WriteHeader(nodeName, len(vertex1by3N) / 3, len(index), len(uvConsolidated))
        ...
        for i in xrange(lPolygonCount):
            for j in xrange(3):
                if leUV.GetMappingMode() == FbxLayerElement.eByPolygonVertex:
                    ...
                    if leUV.GetReferenceMode() == FbxLayerElement.eDirect or leUV.GetReferenceMode() == FbxLayerElement.eIndexToDirect:
                        uvVec = leUV.GetDirectArray().GetAt(lTextureUVIndex)
...
def ComputeNodeWeightsAndIndices(pMesh, vertex1by3N):
    ...
    for i in xrange(lSkinCount):
        print "Safak: lSkinCount =", lSkinCount
        if lSkinCount > 1:
            print ".....\nTrouble!!!"
        ...
        lClusterCount = pMesh.GetDeformer(i, FbxDeformer.eSkin).GetClusterCount()
        ...
        for j in xrange(lClusterCount): # traverse all bones
            lCluster = pMesh.GetDeformer(i, FbxDeformer.eSkin).GetCluster(j)
            print "\n...................\n    Cluster ", i
            ...
            correctedIndices, correctedWeights = WeightsCorrector(pMesh, lIndices, lWeights, vertex1by3N, lControlPoints, 0.0000001)
...
def TextureFiles():
    ...
    """ FbmDir = /Users/ozkansafak/Source Code/YogurtTech/fbx_to_y3d/fbx/simplelifeembedmedia.fbm
    """
    
    """ outputFolder = /Users/ozkansafak/Source Code/YogurtTech/fbx_to_y3d/fbx/simplelifeembedmedia
    """
