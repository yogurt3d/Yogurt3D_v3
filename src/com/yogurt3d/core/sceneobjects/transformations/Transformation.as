...
package com.yogurt3d.core.sceneobjects.transformations {
	...
	public class Transformation extends EngineObject
	{
		...
		public function get xAxisLocal():Vector3D {
			var vec:Vector3D = new Vector3D();
			matrixLocal.copyColumnTo( 0, vec );
			return vec;
		}
		
		public function get yAxisLocal():Vector3D {
			var vec:Vector3D = new Vector3D();
			matrixLocal.copyColumnTo( 1, vec );
			return vec;
		}
		
		public function get zAxisLocal():Vector3D {
			var vec:Vector3D = new Vector3D();
			matrixLocal.copyColumnTo( 2, vec );
			return vec;
		}
