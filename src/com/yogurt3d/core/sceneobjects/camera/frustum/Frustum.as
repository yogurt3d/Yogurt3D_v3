...
//import com.yogurt3d.core.namespaces.YOGURT3D_INTERNAL;
	...
	public class Frustum
	{
		...
		private var m_near					:Number = NaN;
		
		private var m_far					:Number = NaN;
		
		private var m_fov					:Number = NaN;
		 ...
		 * 
		 */		
		public function setProjectionPerspective(_fov:Number, _aspect:Number, _near:Number, _far:Number):void
		{	
			ProjectionUtils.setProjectionPerspective(m_projectionMatrix, _fov, _aspect, _near, _far);
			
			CalcFrustumBSPers(_fov, _aspect, _near, _far);
			CalcFrustumPointsPers(_fov, _aspect, _near, _far);
