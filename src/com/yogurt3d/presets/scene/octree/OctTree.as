...
package com.yogurt3d.presets.scene.octree
{
	...
	public class OctTree
	{
		...
		// recursive
		private function _visibilityProcess( frustum:Frustum, node:OctNode, bTestChildren:Boolean, _renderQueue:RenderQueue) :void
		{		
			var i:int;
					...
					case (Frustum.IN):
						...
						if(lena > 0)
						{
							for(i = 0; i < lena; i++)
							{
								...
								_renderQueue.addRenderable(octantSceneObject);
							}
						}
						bTestChildren = false;
						break;
		...
		// recursive
		private function _visibilityProcessLight( frustum:Frustum, node:OctNode, bTestChildren:Boolean, lightIndex:int, _scene:Scene3D, _renderQueue:RenderQueue) :void
		{		
			var i:int;
